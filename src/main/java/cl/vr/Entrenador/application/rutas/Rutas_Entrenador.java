package cl.vr.Entrenador.application.rutas;
import cl.vr.Entrenador.application.controladores.*;
...
import cl.vr.Entrenador.domain.puertoSalida.*;
...
@Slf4j
public class Rutas_Entrenador {

    @Inject
    Validator validator;

    @Inject
    PuertoSalida_BuscarTodos_Entrenador buscarTodos_PuertoSalida;
    @Inject
    PuertoSalida_BuscarPorID_Entrenador buscarPorID_PuertoSalida;
    @Inject
    PuertoSalida_Crear_Entrenador crear_PuertoSalida;
    @Inject
    PuertoSalida_Actualizar_Entrenador actualizar_PuertoSalida;
    @Inject
    PuertoSalida_Eliminar_Entrenador eliminar_PuertoSalida;
    ...
    public Response getAll() {
        ...
        Controller_BuscarTodos_Entrenador controlador = new Controller_BuscarTodos_Entrenador(buscarTodos_PuertoSalida);
    ...
    public Response getById(@PathParam("id") Long id) throws Exception {
        try {
            ...
            Controller_BuscarPorID_Entrenador controlador = new Controller_BuscarPorID_Entrenador(buscarPorID_PuertoSalida);
    ...
    public Response crear(Request_Save_DTO_Entrenador dto) {
        try {
            Set<ConstraintViolation<Request_Save_DTO_Entrenador>> violations = validator.validate(dto);
            ...
            Controller_Crear_Entrenador controlador = new Controller_Crear_Entrenador(crear_PuertoSalida);
    ...
    public Response fallbackCrear(Request_Save_DTO_Entrenador dto) {
        return Response.status(503).build();
    }
    ...
    public Response actualizar(@PathParam("id") Long id, Request_Update_DTO_Entrenador dto) {
        try {
            Set<ConstraintViolation<Request_Update_DTO_Entrenador>> violations = validator.validate(dto);
            if (!violations.isEmpty()) {
            ...
            Controller_Actualizar_Entrenador controlador = new Controller_Actualizar_Entrenador(actualizar_PuertoSalida);
    ...
    public Response fallbackActualizar(Long id, Request_Update_DTO_Entrenador dto) {
        return Response.status(503).build();
    }
